...
function T1(e) {
  ...
  return S.jsx(an, {
    ...
    children: S.jsx(nl, {
      ...
      children: S.jsxs(LL, {
        children: [
          S.jsx(an, { position: "relative", flexGrow: 1, children: S.jsx("img", { className: "food-image", src: `/images/${n}.png`, alt: `image of ${n}` }) }),
          S.jsx(an, {
            position: "relative",
            height: "20%",
            sx: { textAlign: "center" },
  ...
  return S.jsxs(Rt, {
    ...
    children: [
      S.jsxs(Rt, {
        ...
        width: "100%",
        children: [
          S.jsx(x, { borderRadius: 1, children: S.jsx("img", { className: "food-image", src: `/images/${c}.png`, alt: `photo of ${c}` }) }),
          S.jsxs(Rt, {
            px: 2,
...
const xp = yp("Browser", { web: () => rN(() => import("./web-05e5e800.js"), []).then((e) => new e.BrowserWeb()) })
function pN() {
  const { t: e } = Qt(),
    t = async (n) => {
      await xp.open({ url: n })
