import { DialogTitle, DialogContent, DialogContentText, Typography, Link } from "@mui/material"
...
export default function AboutDialog() {
  ...
  return (
    <>
      <DialogTitle id="about-dialog-title">{t("AboutDialog_title")}</DialogTitle>
      <DialogContent>
        <DialogContentText id="about-dialog-description" color="dark-gray">
          <p>{t("AboutDialog_desc1")}</p>
          <p>{t("AboutDialog_desc2")}</p>

          <Typography sx={{ fontWeight: 600 }}>{t("AboutDialog_ItalyDisclaimer")}</Typography>
          <Typography sx={{ fontWeight: 800, mt: 3 }}>
            ...
            <Link
              ...
              onClick={(e) => {
                e.preventDefault()
                openExternalLink("https://raposinha.dev/")
              }}
            >
              raposinha.dev
            </Link>
